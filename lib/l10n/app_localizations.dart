...
final Map<String, Map<String, String>> _translations = {
  'en': {
    ...
    'noSourcesSub': 'Import a JSON book source to enable online reading.',
  ...
  'zh': {
    ...
    'noSources': '尚未添加书源',
    'noSourcesSub': '导入 JSON 书源即可开启在线阅读。',
    'importJson': '导入 JSON',
    'import': '导入',
    'openingBook': '正在打开书籍',
  ...
  'zh_Hant': {
    ...
    'noSources': '尚未新增書源',
    'noSourcesSub': '匯入 JSON 書源即可開啟線上閱讀。',
    'importJson': '匯入 JSON',
    'import': '匯入',
    'openingBook': '正在開啟書籍',
  ...
  'ja': {
    ...
    'noSources': 'ソースがありません',
    'noSourcesSub': 'JSON のソースをインポートしてください。',
  ...
  'de': {
    ...
    'noSourcesSub': 'Importiere eine JSON-Buchquelle für das Online-Lesen.',
